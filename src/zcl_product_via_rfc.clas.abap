CLASS zcl_product_via_rfc DEFINITION PUBLIC FINAL CREATE PUBLIC .
...
CLASS zcl_product_via_rfc IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA lt_product TYPE STANDARD TABLE OF zce_product.
